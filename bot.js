...
client.login('NDQ1OTM2NjU4MzIwMzI2NjU2.Dd0tUg.RgBlyryy61BAh6-MFAu6Z5NCh20');
...
.addField('     **---broadcast** ' ,' **عمل برود كاست** ')
.addField('     **ping** ' ,' ** سرعة اتصال البوت**')
.addField('     **---clear ** ' ,' **  لمسح الشات   ** ')
.addField('     **---say ** ' ,' **  عشان يتكلم عنك  ** ')
.addField('     **---members ** ' ,' **  عدد الاونلين و البوتات  ** ')
.addField('     **---id ** ' ,' **  لمعرقة معلومات عنك  ** ')
.addField('     **---server ** ' ,' **  لمعرقة معلومات عن السيرفر  ** ')
.addField('     **---ban ** ' ,' **  لعمل باند لشخص  ** ')
.addField('     **---kick ** ' ,' **  لعمل كيك لشخص  ** ')
.addField('     **---invite ** ' ,' **  لعمل انفايت للبوت  ** ')
.addField('     **كت تويت ** ' ,' **  لعمل كت تويت  ** ')
.addField(' **  Welcome|لعمل ترحيب سوى روم اسمة ** ')
.addField(' ** المغادرة مدموجه مع البوت ** ')
.addField(' ** @Mrzizx-Done#9302 | اذا عندك اى اقتراحات كلم ** ')
.setColor('#7d2dbe')
  message.channel.sendEmbed(embed);
    }
});
...
if (message.content === '---invite') {
      message.author.send('  https://discordapp.com/api/oauth2/authorize?client_id=445936658320326656&permissions=8&scope=bot  |  تفضل ربط البوت     ').catch(e => console.log(e.stack));
